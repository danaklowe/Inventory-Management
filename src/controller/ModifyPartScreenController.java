...
public class ModifyPartScreenController implements Initializable {
    ...
    public void initData(Part part){
        ...
        if(part instanceof InHouse){
            coNameMachineIDTxt.setText(String.valueOf(((InHouse)selectedPart).getMachineId()));
            inHouseRBtn.setSelected(true);
            coNameMachineIDLbl.setText("Machine ID");
        }
        
        if(part instanceof Outsourced){
            coNameMachineIDTxt.setText(String.valueOf(((Outsourced)selectedPart).getCompanyName()));
    ...
    private void saveBtnClicked(ActionEvent event) throws IOException {
        ...
        try{
            if (inHouseRBtn.isSelected()){
                ...
                Inventory.updatePart(Integer.parseInt(idTxt.getText()) -1, newPart);
            }
